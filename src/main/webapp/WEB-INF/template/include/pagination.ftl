...
[/#if]
    <span class="pageSkip">
			${message("page.totalPages", totalPages)} ${message("page.pageNumber", '<input id="currpage" name="currpage" value="' + pageNumber + '" maxlength="9" size="6" onpaste="return false;" />')}<button type="submit">&nbsp;</button>
		</span>
</div>
[#--[/#if]--]