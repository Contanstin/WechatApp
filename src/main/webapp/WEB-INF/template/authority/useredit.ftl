...
<form id="inputForm" action="userUpdate.jhtml" method="post">
    ...
    <table class="input">
        <tr>
            ...
            <td>
                <input type="text" name="userName" class="text" value="${usermodel.userName}" maxlength="20" />
            </td>
        </tr>
        <tr>
            <th>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="department" class="text" value="${usermodel.department}" maxlength="200" />
            </td>
        </tr>
        <tr class="roles">
            <th>
            ...
            <td>
                    ...
                    [#list roles as role]
                        <label>
                            <input type="radio" name="roleId" value="${role.id}" [#if role.id==userrole.roleId] checked="checked"[/#if]/>${role.name}
                        </label>
                    [/#list]
					</span>
            </td>
        ...
        <tr>
            ...
            <td>
                <label>
                    <input type="checkbox" name="isEnable" value="true" [#if usermodel.isEnable] checked="checked"[/#if]/>是否启用
                </label>
            </td>
        </tr>
