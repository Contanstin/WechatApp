...
import com.hpmont.util.page.Pageable;
...
public class BaseDAO extends SqlSessionDaoSupport {
    ...
    @SuppressWarnings("unchecked")
    public <T> com.hpmont.util.page.Page<T> selectPageList(String sqlid, Object paramObj, int currpage, int prePageRows) {
        PageHelper.startPage(currpage, prePageRows);
        Page<T> pageRs=(Page<T>) this.getSqlSession().selectList(sqlid, paramObj);
        Pageable pageable=new Pageable(pageRs.getPageNum(),pageRs.getPageSize());
        return new com.hpmont.util.page.Page<T>((List<T>) pageRs,pageRs.getTotal(),pageable);
    }
